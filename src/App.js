...
//import Universities from './sections/UniversityPage/Universities';
import UniversityPage from './sections/UniversityPage/UniversityPage';
import Home from "./sections/Home/Home";
import StudyAbroad from './sections/Community/StudyAbroad';
// Import Css Here 
import './assets/scss/style.scss';
import EBook from './sections/ebook/eBook';
// import EBookInner from './sections/ebookinner/eBookInner';
...
import IeltsInner from './sections/ielts/ieltsInner';
        ...
        <Router>
            <ScrollToTop>
                <Routes>
                    ...
                    <Route exact path={`${process.env.PUBLIC_URL + '/eBookInner'}`} element={<EBookInner/>}/>
                    <Route exact path={`${process.env.PUBLIC_URL + '/ielts'}`} element={<Ielts/>}/>
                    <Route exact path={`${process.env.PUBLIC_URL + '/ieltsInner'}`} element={<IeltsInner/>}/>
                    
                    <Route exact path={`${process.env.PUBLIC_URL + '/destination'}`} element ={<Destination/>}/>
                    ...
                    {/* add universities route */}
                    <Route exact path={`${process.env.PUBLIC_URL + '/universities'}`} element={<Universities/>}/>

                    {/* university page route */}
                    <Route exact path={`${process.env.PUBLIC_URL + '/universities/:slug'}`} element={<UniversityPage/>}/>                
