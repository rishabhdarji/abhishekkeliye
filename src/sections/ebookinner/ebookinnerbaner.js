                    ...
                    <div className="col-lg-6">
                        <div className="inner">
                            ...
                            {/* <ScrollAnimation
                                ...
                                animateOnce={true}
                            > */}
                                <Link className="edu-btn" to="/about-us-1">download<i className="icon-arrow-right-line-right"></i></Link>
                                <Link className="edu-btn" style={{margin : "25px"}} to="/about-us-1">save for later<i className="icon-arrow-right-line-right"></i></Link>
                            {/* </ScrollAnimation> */}
                            {/* <ScrollAnimation
                                animateIn="fadeInUp"
                                animateOut="fadeInOut"
                            ...
                            > */}
                                <p className="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nunc
                                    null liobortis nibh porttitor. Facilisi arcu, nibh vel risus,Facilisi arcu, nibh vel risus, morbi pharetra.</p>
                            {/* </ScrollAnimation> */}
...
export default EbookInnerBaner;